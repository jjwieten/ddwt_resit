...
/**
 *  Sets the HTTP Header to application/json
 */
...
/**
 * Check user credentials against server credentials
 * @param $cred array containing credentials
 * @return bool representing succes of authentication
 */
